...
*/
export const Variant = Object.freeze({ CHIP8:0,"0":"CHIP8",SCHIP_LEGACY:1,"1":"SCHIP_LEGACY",SCHIP_MODERN:2,"2":"SCHIP_MODERN",XOCHIP:3,"3":"XOCHIP", });

const Chip8Finalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_chip8_free(ptr >>> 0));
/**
*/
export class Chip8 {
    ...
    */
    constructor(variant) {
        const ret = wasm.chip8_new(variant);
    ...
    */
    load_font() {
        wasm.chip8_load_font(this.__wbg_ptr);
    }
    /**
    * Load a ROM into memory at 0x0200 from a file
    * @param {string} rom
    */
    load_rom_from_file(rom) {
        const ptr0 = passStringToWasm0(rom, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.chip8_load_rom_from_file(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    */
    get_display() {
        try {
            ...
            wasm.chip8_get_display(retptr, this.__wbg_ptr);
    ...
    */
    run() {
        wasm.chip8_run(this.__wbg_ptr);
    }
    /**
    * @param {number} key_index
    * @param {boolean} value
    */
    set_keypad_state(key_index, value) {
        wasm.chip8_set_keypad_state(this.__wbg_ptr, key_index, value);
    }
    /**
    */
    decrement_timers() {
